...
class Dissassembler{
	...
	void print_all(){
		...
		*/
		...
		out2 << "--------------------" << endl;
		out2 << "Cycle:" << CYCLE << endl;
		out2 << "IF Unit:" << endl;
		out2 << "\tWaiting Instruction: " << s_fetch_queue[1] << endl;
		out2 << "\tExecuted Instruction: " << s_fetch_queue[0] << endl;
		
		out2 << "Pre-Issue Queue:" << endl;
		out2 << "\tEntry 0: " << s_pre_issue[0] << endl;
		out2 << "\tEntry 1: " << s_pre_issue[1] << endl;
		out2 << "\tEntry 2: " << s_pre_issue[2] << endl;
		out2 << "\tEntry 3: " << s_pre_issue[3] << endl;

		out2 << "Pre-ALU1 Queue:" << endl;
		out2 << "\tEntry 0: " << s_pre_ALU1[0] << endl;
		out2 << "\tEntry 1: " << s_pre_ALU1[1] << endl;

		out2 << "Pre-MEM Queue: " << s_pre_MEM << endl;

		out2 << "Post-MEM Queue: " << s_post_MEM << endl;

		out2 << "Pre-ALU2 Queue:" << endl;
		out2 << "\tEntry 0: " << s_pre_ALU2[0] << endl;
		out2 << "\tEntry 1: " << s_pre_ALU2[1] << endl;

		out2 << "Post-ALU2 Queue: " << s_post_ALU2 << endl;
	...
	*/
	...
	void simulate(){
		...
		while(EXIT){
			if(pre_issue_queue_entries == 4){
				fetch_flag0 = 1;
			}else if(pre_issue_queue_entries == 3){
				fetch_flag1 = 1;
			}
